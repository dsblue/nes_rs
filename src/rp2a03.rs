...
mod test {
    ...
    //         mm.set_internal_ram(vec![(0x200, 0x69), (0x201, val)]);
    ...
    //         mm.set_internal_ram(vec![(0x200, 0x65), (0x201, 0x30), (0x30, val)]);
    //         set_state(&mut cpu, &init);
    //         run(&mut cpu, &mut mm, 3);
    //         assert_eq!(cpu.inst, Instruction::Adc(AddressMode::Zp));
    //         assert_eq!(end, get_state(&cpu), "{:?} {}", cpu.inst, desc);

    //         mm.set_internal_ram(vec![(0x200, 0x75), (0x201, 0x30), (0x50, val)]);
    //         init.x = 0x20;
    //         end.x = 0x20;
    //         set_state(&mut cpu, &init);
    ...
    //         let mut cpu = Cpu6502::new();
    //         set_state(&mut cpu, &init);
    //         mm.set_internal_ram(vec![(0x200, 0x85), (0x201, 0x30)]);
    //         run(&mut cpu, &mut mm, 3);
    //         end.pc = init.pc + 2;
    //         assert_eq!(cpu.inst, Instruction::Sta(AddressMode::Zp));
    //         assert_eq!(end, get_state(&cpu), "{:?} {}", cpu.inst, desc);
    //         assert_eq!(a, mm.internal_ram[0x30]);

    //         let mut cpu = Cpu6502::new();
    //         mm.set_internal_ram(vec![(0x200, 0x95), (0x201, 0x30)]);
    //         init.x = 0x20;
    //         end.x = 0x20;
    //         set_state(&mut cpu, &init);
    //         run(&mut cpu, &mut mm, 4);
    ...
    //         assert_eq!(end, get_state(&cpu), "{:?} {}", cpu.inst, desc);
    //         assert_eq!(a, mm.internal_ram[0x50]);

    //         let mut cpu = Cpu6502::new();
    //         mm.set_internal_ram(vec![(0x200, 0x8D), (0x201, 0x23), (0x202, 0x01)]);
    //         end.pc = init.pc + 3;
    //         set_state(&mut cpu, &init);
    //         run(&mut cpu, &mut mm, 4);
    //         assert_eq!(cpu.inst, Instruction::Sta(AddressMode::Abs));
    //         assert_eq!(end, get_state(&cpu), "{:?} {}", cpu.inst, desc);
    //         assert_eq!(a, mm.internal_ram[0x0123]);

    //         let mut cpu = Cpu6502::new();
    //         mm.set_internal_ram(vec![(0x200, 0x9D), (0x201, 0x23), (0x202, 0x01)]);
    //         init.x = 0x20;
    //         end.x = 0x20;
    //         end.pc = init.pc + 3;
    //         set_state(&mut cpu, &init);
    ...
    //         assert_eq!(end, get_state(&cpu), "{:?} {}", cpu.inst, desc);
    //         assert_eq!(a, mm.internal_ram[0x0143]);

    //         let mut cpu = Cpu6502::new();
    //         mm.set_internal_ram(vec![(0x200, 0x99), (0x201, 0x23), (0x202, 0x01)]);
    //         init.y = 0x30;
    //         end.y = 0x30;
    //         end.pc = init.pc + 3;
    //         set_state(&mut cpu, &init);
    ...
    //         assert_eq!(end, get_state(&cpu), "{:?} {}", cpu.inst, desc);
    //         assert_eq!(a, mm.internal_ram[0x0153]);
